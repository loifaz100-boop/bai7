...
import java.util.*; // 1. LỖI CHẾT NGƯỜI: Wildcard import (Google cực ghét dấu *)
...
public class MathService {
    /**
     * Ham nay se bi checkstyle vả vao mat.
     */
    public int add(int a, int b) {
        // 2. LỖI CHÍ MẠNG: Dòng này mình đang dùng phím TAB để thụt lề (Google chỉ cho dùng 2 dấu cách).
